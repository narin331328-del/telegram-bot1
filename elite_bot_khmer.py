...
# ==========================================
# #HELPER_FUNCTION: បែងចែកអត្ថបទវែងពេកមិនឱ្យ Error 400
# ==========================================
def send_long_message(chat_id, text, reply_markup=None):
  ...
  if len(text) <= max_length:
    ...
    for idx, part in enumerate(parts):
      if idx == len(parts) - 1:
        bot.send_message(
            chat_id, part, reply_markup=reply_markup, parse_mode="Markdown"
        )
      else:
...
if __name__ == "__main__":
  ...
  print("Bot is running successfully with long message handler...")
